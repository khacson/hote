...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('linh-vuc-hoat-dong');?></div>	
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_p.activefields_name"><?=getLanguage('linh-vuc-hoat-dong')?></th>
								<th id="ord_p.activefields_name"><?=getLanguage('vi-tri')?></th>
								<th></th>
								<th></th>
							</tr>
						</table>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="activefields_name" id="activefields_name" class="searchs form-control" />
								</td>
								<td>
...
<script>
	...
	function searchFunction(){
		$("#activefields_name,#ordering").keyup(function() {
			searchList();	
		});
	}
	...
	function save(func,id){
		...
		if(obj.activefields_name == ""){
			warning('<?=getLanguage('linh-vuc-hoat-dong-khong-duoc-trong');?>'); 
			$("#activefields_name").focus();
			return false;		
		}
		$('.loading').show();
		$.ajax({
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var activefields_name = $('.activefields_name').eq(e).html().trim();
				 var id = $(this).attr('id');
				 $('#id').val(id);	
				 $('#activefields_name').val(activefields_name);
			});
		});	
