...
<div class="row mtop10">
	<div class="col-md-6">
		<div class="form-group">
			<label class="control-label col-md-4"><?=getLanguage('loai-phieu-chi');?></label>
			<div class="col-md-8">
				<select id="input_liabilities" name="input_liabilities" class="combos-input select2me form-control" data-placeholder="<?=getLanguage('chon-loai-phieu-chi')?>">
