...
<table border="1" class="finds" width="100%">
  <tr>
	<td width="40" rowspan="2" align="center" valign="middle"><strong>STT</strong></td>
	...
	<td width="60" rowspan="2" align="center" valign="middle"><strong>DVT</strong></td>
	<td width="70" rowspan="2" align="center" valign="middle"><strong>Số lượng</strong></td>
	<td width="70" rowspan="2" align="center" valign="middle"><strong>Đơn giá</strong></td>
	<td colspan="2" align="center" valign="middle"><strong>Chiết khấu</strong></td>
	<td width="75" rowspan="2" align="center" valign="middle"><strong>Thành tiền</strong></td>
  </tr>
  <tr>
