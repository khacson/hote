...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('nhom-khach-hang');?></div>	
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_p.customergroup_name"><?=getLanguage('nhom-khach-hang')?></th>
								<th id="ord_p.customergroup_name"><?=getLanguage('vi-tri')?></th>
								<th></th>
								<th></th>
							</tr>
						</table>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="customergroup_name" id="customergroup_name" class="searchs form-control" />
								</td>
								<td>
...
<script>
	...
	function searchFunction(){
		$("#customergroup_name,#ordering").keyup(function() {
			searchList();	
		});
	}
	...
	function save(func,id){
		...
		if(obj.customergroup_name == ""){
			warning('<?=getLanguage('nhom-khach-hang-khong-duoc-trong');?>'); 
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var customergroup_name = $('.customergroup_name').eq(e).html().trim();
				 var id = $(this).attr('id');
				 $('#id').val(id);	
				 $('#customergroup_name').val(customergroup_name);
			});
		});	
