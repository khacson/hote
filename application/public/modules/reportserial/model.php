 ...
 * @copyright 2015
 */
 class ReportserialModel extends CI_Model{
	...
	function getSearch($search){
		...
		if(!empty($search['customer_type'])){ //Đơn hàng
	...
	function getList($search,$page,$rows){
		...
		$sql = "SELECT w.warehouse_name, e.username as employee_code ,
				...
				AND c.isdelete = 0 
				and g.isdelete = 0
				and (so.serial_number <> '' and so.serial_number is not null)
				$searchs
				";
