...
<table border="1" class="datas" width="100%"  >
  <tr>
	<th width="50" rowspan="2" align="center" valign="middle"><strong>STT</strong></th>
	<th width="80" rowspan="2" align="center" valign="middle"><strong>Mã hàng</strong></th>
	<th rowspan="2" align="center" valign="middle"><strong>Tên hàng</strong></th>
	<th width="70" rowspan="2" align="center" valign="middle"><strong>ĐVT</strong></th>
	<th width="70" rowspan="2" align="center" valign="middle"><strong>Số lượng</strong></th>
	<th width="80" rowspan="2" align="center" valign="middle"><strong>Đơn giá</strong></th>
	<th width="142" colspan="2" align="center" valign="middle"><strong>Chiết khấu</strong></th>
	<th width="90" rowspan="2" align="center" valign="middle"><strong>Thanh toán</strong></th>
  </tr>
  <tr>
	 <th width="70" align="center" valign="middle"><strong>Tiền</strong></th>
	 <th width="70" align="center" valign="middle"><strong>Sản phẩm</strong></th>
  </tr>
  <?php $i=1; 
  $tprice = 0;
  $t_discount_value = 0;
  ...
  foreach($detail as $item){
	  ...
	  $price_total = $item->price_total;//($item->price_total) -  $t_discount_value + ($adjustment);
	  $vat = $item->vat;
...
<style type="text/css">
	...
	.datas td{ border:1px solid #666; padding:3px;}
</style>
