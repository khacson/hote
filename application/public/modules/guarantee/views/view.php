		...
		<div class="row">
			<div class="col-md-4" >
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="serial_number" id="serial_number" placeholder="Nhập serial" class="searchs form-control tab-event" maxlength="30"  />
					</div>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-4" >
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="customer_phone" id="customer_phone" placeholder="" class="searchs form-control tab-event" maxlength="50" />
					</div>
				</div>
			</div>
		</div>
		<div class="row mtop10">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-8">
						<select id="statusguarantee" name="statusguarantee" class="combos tab-event">
							<option value=""></option>
		...
		<div class="row mtop10">
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" id="goodsidsearch" placeholder="Nhập mã hàng" name="goodsidsearch" class="form-control searchs tab-event" maxlength="30" />
					</div>
				</div>
			</div>
			<div class="col-md-4">
