...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('quan-huyen');?></div>	
		</div>
		<div class="tools">
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="distric_name" id="distric_name" class="searchs form-control " />
								</td>
								<td>
...
<script>
	...
	function save(id,func){
		...
		if(obj.distric_name == ""){
			warning('<?=getLanguage('quan-huyen-khong-duoc-trong');?>'); 
			$("#distric_name").focus();
			return false;		
		}
		if(obj.provinceid == ""){
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var distric_name = $('.distric_name').eq(e).html().trim();
				 var id = $(this).attr('id');
				 var provinceid = $(this).attr('provinceid');
				 $('#id').val(id);	
				 $('#distric_name').val(distric_name);
