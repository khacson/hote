...
foreach ($datas as $key => $item){
	...
	birthday = '<?=$birthday;?>'
	checkprint = "<?=$item->checkprint;?>" provinceid="<?=$item->provinceid;?>" id="<?=$item->id;?>" 
	...
	>
		...
		<td class="customertype_name"><?=$item->customergroup_name;?></td>
		<td class="customertype_name"><?=$item->customertype_name;?></td>
