<ul class="nav nav-tabs" style="margin-top:-10px;">
  ...
  <li id="loadrawdata" class="hiddensave"><a data-toggle="tab" href="#menu2"><?=getLanguage('thong-tin-xuat-hang');?></a></li>
...
<div class="tab-content">
    <div id="home" class="tab-pane fade in active">
		...
		<div class="row mtop10">
			...
			<div class="col-md-6">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('nhom-khach-hang');?></label>
					<div class="col-md-8">
						<select id="input_customergroupid" name="input_customergroupid" class="combos-input select2me form-control" data-placeholder="<?=getLanguage('chon-nhom-khach-hang')?>" >
							<option value=""></option>
							<?php foreach($customerGroups as $item){?>
								<option <?php if($finds->customergroupid == $item->id){?> selected <?php }?> value="<?=$item->id;?>"><?=$item->customergroup_name;?></option>
							<?php }?>
						</select>
					</div>
				</div>
		...
		<div class="row mtop10">
			<div class="col-md-6">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('phan-loai-khach-hang');?></label>
					<div class="col-md-8">
						<select id="input_customertypeid" name="input_customertypeid" class="combos-input select2me form-control" data-placeholder="<?=getLanguage('chon-phan-loai-khach-hang')?>" >
							<option value=""></option>
							<?php foreach($customerTypes as $item){?>
								<option <?php if($finds->customertypeid == $item->id){?> selected <?php }?> value="<?=$item->id;?>"><?=$item->customertype_name;?></option>
							<?php }?>
						</select>
					</div>
				</div>
