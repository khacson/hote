...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption caption2">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('hang-hoa');?></div>	
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>	
								...
								<th id="ord_p.goods_tye_name"><?=getLanguage('loai-hang-hoa');?></th>
								<th id="ord_ut.unit_name"><?=getLanguage('don-vi-tinh');?></th>
								<th id="ord_ut.unit_name"><?=getLanguage('dv-mac-dich');?></th>
...
<div class="loading" style="display: none;">
	<div class="blockUI blockOverlay" style="width: 100%;height: 100%;top:0px;left:0px;position: absolute;background-color: rgb(0,0,0);opacity: 0.1;z-index: 999000;">
	</div>
	<div class="blockUI blockMsg blockElement" style="width: 30%;position: absolute;top: 15%;left:35%;text-align: center;">
		<img src="<?=url_tmpl()?>img/ajax_loader.gif" style="z-index: 2;position: absolute; z-index: 999000;"/>
	</div>
</div>
 <!-- Modal -->
...
<div id="myModalFromType" class="modal fade" role="dialog">
  <div class="modal-dialog w500">
    ...
    <div class="modal-content ">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title" id="modalTitleFromType"><?=getLanguage('them-loai-hang-hoa');?></h4>
      </div>
...
<script>
	...
	function init(){
		...
		$('#goods_type').multipleSelect({
			filter: true,
			single: false,
			placeholder: "<?=getLanguage('chon-loai-hang-hoa')?>",
