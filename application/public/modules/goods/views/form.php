...
<div class="tab-content">
    <div id="home" class="tab-pane fade in active">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('ma-hang-hoa');?></label>
					<div class="col-md-8">
			...
			<div class="col-md-6">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('ten-hang-hoa');?> (<span class="red">*</span>)</label>
					<div class="col-md-8">
		...
		<div class="row mtop10">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-md-7">
							<select id="input_goods_type" name="input_goods_type" class="combos-input select2me form-control" data-placeholder="<?=getLanguage('chon-loai-hang-hoa');?>">
		...
		<div class="row mtop10">
			...
			<div class="col-md-6">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('dv-mac-dich');?> </label>
					<div class="col-md-8">
						<span>
							<select id="input_unitid_active" name="input_unitid_active" class="combos-input select2me form-control" data-placeholder="<?=getLanguage('chon-don-vi-tinh')?>">
								<option value=""></option>
								<?php foreach($units as $item){?>
									<option  <?php if($finds->unitid_active == $item->id){?> selected <?php }?> value="<?=$item->id;?>"><?=$item->unit_name;?></option>
								<?php }?>
							</select>
						</span>
					 </div>
		...
		<div class="row mtop10">
				...
				<div class="form-group">
					...
					<div class="col-md-8" style="padding-left:0 !important;">
						...
						<div class="col-md-5" style="padding-left:0 !important; padding-right:0 !important;">
							<select id="input_discountsales_type" name="input_discountsales_type" class="combos-input select2me form-control" data-placeholder="<?=getLanguage('chon-loai')?>">
								<option <?php if(1 == $finds->discountsales_type){?> selected <?php }?> value="1">%</option>
								<option <?php if(2 == $finds->discountsales_type){?> selected <?php }?> value="2"><?=configs()['currency'];?></option>
							</select>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-md-8" style="padding-left:0 !important;">
						<div class="col-md-7">
							<input type="text" name="input_discountsales_dly" id="input_discountsales_dly" placeholder="" maxlength="12" class="form-input form-control text-right " value="<?=$finds->discountsales_dly;?>" />
						</div>
						<div class="col-md-5" style="padding-left:0 !important; padding-right:0 !important;">
							<select id="input_discountsales_type_dly" name="input_discountsales_type_dly" class="combos-input select2me form-control" data-placeholder="<?=getLanguage('chon-loai')?>">
								<option <?php if(1 == $finds->discountsales_type_dly){?> selected <?php }?> value="1">%</option>
								<option <?php if(2 == $finds->discountsales_type_dly){?> selected <?php }?> value="2"><?=configs()['currency'];?></option>
							</select>
						</div>
					</div>
				</div>
...
<script>
	...
	function initForm(){
		/*$('#input_unitid').change(function() {
			var unitid = $('#input_unitid').val();
