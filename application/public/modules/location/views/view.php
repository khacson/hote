...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption caption2">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('vi-tri-luu-kho');?></div>		
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_l.location_name"><?=getLanguage('vi-tri')?></th>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="location_name" id="location_name" class="searchs form-control " />
								</td>
								<td>
...
<script>
	...
	function searchFunction(){
		$("#location_name,#description").keyup(function() {
			searchList();	
		});
	}
	...
	function save(){
		...
		if(obj.location_name == ''){
			warning("<?=getLanguage('vi-tri-khong-duong-trong')?>"); return false;	
		}
		var token = $('#token').val();
		$('.loading').show();
		$.ajax({
