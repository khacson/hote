...
<div class="portlet box blue mtop0">
	<div class="portlet-title portlet-title2">
		<div class="caption caption2">
			<div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('bao-gia');?></div>	
		</div>
		<div class="tools">
			 <ul class="button-group pull-right"  style="margin-top:-5px; margin-bottom:5px;">
						...
						<li>
							<a id="export">
								<button class="button">
									<i class="fa fa-envelope-o"></i>&nbsp;<?=getLanguage('send-mail')?>
								</button>
							</a>
						</li>
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>
								...
								<th id="ord_c.poid"><?=getLanguage('ma-bao-gia');?></th>
								...
								<th id="ord_c.customerid"><?=getLanguage('khach-hang');?></th>
...
<script>
	...
	$(function(){
		...
		$('.datepoClick,.datecreateClick').click(function(){
			$('#datepo').click();
		});
		setDefault();
		searchFunction();
