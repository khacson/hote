...
<tr class="tgrid">
	...
	<td ><input goodid="<?=$item->id;?>" min="1" type="number" name="quantity" id="<?=$item->goods_code;?>" placeholder="" class="search form-control quantity text-right fm-number" value="<?=fmNumber($item->quantity);?>" /></td>
