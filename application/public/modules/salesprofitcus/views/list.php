...
foreach ($datas as $key => $item) { 
	...
	<tr class="content edit" >
		...
		<td class="quantity text-right"><?=number_format($item->quantity);?></td>
		<td class="price text-right"><?=number_format($item->price);?></td>
		<td class="price text-right"><?=number_format($item->o_quantity);?></td>
		<td class="price text-right"><?=number_format($item->o_price);?></td>
		<td></td>
	</tr>
