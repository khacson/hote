...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('phan-loai-khach-hang');?></div>	
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_p.customertype_name"><?=getLanguage('phan-loai-khach-hang')?></th>
								<th id="ord_p.customertype_name"><?=getLanguage('vi-tri')?></th>
								<th></th>
								<th></th>
							</tr>
						</table>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="customertype_name" id="customertype_name" class="searchs form-control" />
								</td>
								<td>
									<input type="text" name="ordering" id="ordering" class="searchs form-control" />
								</td>
								<td><td>
							</tr>
...
<script>
	...
	function searchFunction(){
		$("#customertype_name,#ordering").keyup(function() {
			searchList();	
		});
	}
	...
	function save(func,id){
		...
		if(obj.customertype_name == ""){
			warning('<?=getLanguage('phan-loai-khach-hang-khong-duoc-trong');?>'); 
			$("#customertype_name").focus();
			return false;		
		}
		$('.loading').show();
		$.ajax({
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var customertype_name = $('.customertype_name').eq(e).html().trim();
				 var id = $(this).attr('id');
				 $('#id').val(id);	
				 $('#customertype_name').val(customertype_name);
			});
		});	
