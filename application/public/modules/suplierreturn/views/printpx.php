...
<table border="0" width="750" >
	<tr >
    	<td colspan="2" align="center"><H2>PHIẾU XUẤT KHO</H2></td>
    </tr>
	<tr>
    	<td><b>Khách hàng:</b>
		<?php 
	...
	<!--<tr>
    	<td><b>Lý do xuất</b>: Xuất bán khách hàng <?=$datas->customer_name;?></td>
        <td></td>
    </tr>
	<tr>
    	<td><b>Xuất tại kho</b>: <?=$datas->warehouse_name;?></td>
        <td></td>
    </tr>-->
...
<table border="1" class="datas" width="750">
  ...
  if(!empty($datas->vat))
  {
	  $tongvat = round($datas->vat * $tprice /100);
	  ?>
  <tr>
	 <td colspan="6" style="text-align:right;"><b>Thuế VAT(%)</b>:</td>
	 <td style="text-align:right;"><?=($datas->vat);?></td>
  </tr>
  <tr>
...
<table border="0" style="margin-top:10px;">
	<tr>
    	<td colspan="2">Thành tiền <i style="text-transform:capitalize;">(Viết bằng chữ)</i>:  <?=$price_prepay;?>
		</td>
    </tr>
</table>
