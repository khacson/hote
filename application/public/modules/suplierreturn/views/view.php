						...
						<span id="loaddonhang">
							<select id="idss" name="idss" class="combos" >
								...
								<?php foreach($orders as $item){?>
									...
									?> value="<?=$item->id;?>">PO<?=$item->poid;?></option>
								<?php }?>
							</select>
						</span>
					</div>
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_c.customer_phone">Địa chỉ</th>
								<th id="ord_e.employee_code">NV bán hàng</th>
								<th></th>
							</tr>
						</table>
					</div>
