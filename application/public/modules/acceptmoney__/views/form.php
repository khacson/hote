<div class="row">
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-8" >
				<select name="input_useraceptid" id="input_useraceptid"  class="form-control select2me"  data-placeholder="<?=getLanguage('chon-nguoi-nhan')?>">
	...
	<div class="col-md-12 mtop10">
		<div class="form-group">
			...
			<div class="col-md-8" >
				<select name="input_personid" id="input_personid" class="form-control select2me"  data-placeholder="<?=getLanguage('chon-nguoi-giao')?>">
					<option value=""></option>
					<?php 
