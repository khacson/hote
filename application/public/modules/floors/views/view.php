...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('tang-lau');?></div>		
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_f.floor_name"><?=getLanguage('tang-lau')?></th>
								<th id="ord_f.description"><?=getLanguage('ghi-chu')?></th>
								<th id="ord_f.branchid"><?=getLanguage('chi-nhanh')?></th>
								<th></th>
								<th></th>
							</tr>
						</table>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="floor_name" id="floor_name" class="searchs form-control " />
								</td>
								<td>
...
<script>
	...
	function searchFunction(){
		$("#floor_name,#description").keyup(function() {
			searchList();	
		});
	}
	...
	function save(){
		...
		if(obj.floor_name == ''){
			warning('<?=getLanguage('tang-lau-khong-duoc-trong');?>'); return false;	
		}
		var token = $('#token').val();
		$('.loading').show();
		$.ajax({
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var floor_name = $('.floor_name').eq(e).html().trim();
