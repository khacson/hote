					...
					<div class="row" style="margin-bottom:15px;">
						<div class="row">
							<div class="form-group col-md-12">
								<label  class="control-label col-md-2" style=";">Hàng hóa(<span class="red">*</span>)</label>
								<div class="col-md-10">
					...
					<div class="row mtop10">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-8 ">
									<input type="text" name="place_of_delivery" id="place_of_delivery" placeholder="Địa điểm giao hàng" value="" class="searchs form-control tab-event" maxlength="100" />
								</div>
							</div>
						</div>
					</div>
					<div class="row mtop10">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-8 ">
									<input maxlength="250" type="text" name="description" id="description" placeholder="" value="" class="searchs form-control tab-event" />
								</div>
							</div>
						</div>
					</div><!--E Row-->
...
<script>
	...
	function save(func,id){ 
		...
		$.ajax({
			...
			error : function(){
				$(".loading").hide();
				error('Tạo đơn hàng không thành công.'); return false;
			}
		});
	}
