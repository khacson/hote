...
<tr class="tgrid">
	...
	<td >
		<input goodid="<?=$item->id;?>" discount_types="<?=$item->discount_types;?>" type="text" id="discount_<?=$item->id;?>" placeholder="" class="search form-control discount text-right tab-event" value="<?=$discount_value;?>" style="font-size:12px; float:left; width:100%;" 
	/>
	</td>
	<td>
