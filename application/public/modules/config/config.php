...
class Config extends CI_Controller {
	...
	function edit() {
		...
		$description = 'Sửa';
		$this->base_model->addAcction('Cấu hình',$this->uri->segment(2),json_encode($acction_before),json_encode($array),$description);
	...
	function deletes() {
		...
		$this->model->table('hr_religion')->save($id, $array);	
