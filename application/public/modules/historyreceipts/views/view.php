	...
	<div class="portlet-body">
		<div class="row">
			<div class="col-md-4 ">
				<div class="form-group">
					<label class="control-label col-md-4">thu nhánh</label>
					<div class="col-md-8">
		...
		<div class="row">	
			<div class="col-md-4 mtop10">
				<div class="form-group">
					<label class="control-label col-md-4">Mã phiếu thu</label>
					<div class="col-md-8">
						<input type="text" id="pay_code" placeholder="Nhập mã phiếu thu" name="pay_code" class="form-control searchs tab-event" maxlength="20" >
					</div>
				</div>
			</div>
			<div class="col-md-4 mtop10">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_sp.customerid">Khách hàng</th>		
								<th id="ord_sp.poid">Đơn hàng</th>
								<th id="ord_sp.pay_code">Mã phiếu thu</th>
								<th id="ord_sp.amount">Số tiền</th>
								<th id="ord_sp.payment">HT thanh toán</th>
								<th id="ord_sp.datepo">Ngày thu</th>
								<th id="ord_sp.pay_type">Loại phiếu thu</th>
								<th>Ghi chú</th>
...
<div class="modal fade" id="myFrom" role="dialog">
 ...
 thu tiết công nợ đơn hàng <span class="podetail"></span></h4>
		</div>
...
<script>
	...
	$(function(){
		...
		$('#printpc').click(function(){
			...
			if(uniqueid == ""){
				warning('Chọn đơn hàng để in phiếu thu'); return false;	
				return false;
			}
			$.ajax({
