...
<tr class="tgrid">
	...
	<td >
		<input goodid="<?=$item->id;?>" type="text" name="price_<?=$item->id;?>" id="price_<?=$item->id;?>" class="search buyprice form-control price text-right fm-number " value="<?=fmNumber($item->price_total);?>" style="font-size:12px; float:left; width:100%;"  /> 
	</td>
	<td width="40">
