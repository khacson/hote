							...
							<div class="form-group">
								<label class="control-label col-md-4">Ngày xuất</label>
								 <div class="col-md-8 input-group date date-picker" data-date-format="<?=cfdateHtml();?>">
									...
									?>
									<input type="text" id="datecreate" placeholder="<?=cfdateHtml();?>" name="datecreate" class="form-control searchs tab-event" >
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label col-md-4">Ngày giao</label>
								 <div class="col-md-8 input-group date date-picker" data-date-format="<?=cfdateHtml();?>">
									<input type="text" id="deliverydate" placeholder="<?=cfdateHtml();?>" name="deliverydate" class="form-control searchs tab-event" >
									<span class="input-group-btn ">
										<button class="btn default btn-picker" type="button"><i class="fa fa-calendar "></i></button>
									</span>
								</div>
					...
					<div class="row mtop10">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-8 ">
									<input type="text" name="description" id="description" placeholder="" value="" maxlength="250" class="searchs form-control tab-event" />
								</div>
							</div>
						</div>
					</div><!--E Row-->
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-8 ">
									...
									<div class="col-md-4">
										<label <?php if($finds->payments == 2){?>checked<?php }?> class="control-label">
...
<script>
	...
	function save(func,id){ 
		...
		$.ajax({
			...
			error : function(){
				$(".loading").hide();
				error('Sửa đơn hàng không thành công.'); return false;
			}
		});
	}
		...
		$('.unitid').each(function(){ 
			$(this).on('change',function(){
				...
				$.ajax({
					...
					type: 'POST',
					async: false,
					data: {unitid:unitid,goodid:goodid,isnew:0},
					success:function(datas){}
				}); 
			});
		});
