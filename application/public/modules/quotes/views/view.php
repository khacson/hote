...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption mtop8">
			...
			<?=getLanguage('tao-don-dat-hang');?></b>
		</div>
		<div class="tools">
			<ul class="button-group pull-right mbottom10">
				...
				<li>
					<a href= "<?=base_url();?>historyquotes.html">
						<button class="button">
		...
		<div class="row ">
			  ...
			  <div class="col-md-4" style="margin-left:1%; width:29%; border-left:1px dashed #c3cfd7;  margin-bottom:10px; padding-left:5px;">
					...
					<div class="row mtop10">
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label col-md-4"><?=getLanguage('ngay-bao-gia');?></label>
...
<script>
	...
	function calInputTotal(){
		...
		$('#total-tamung').val(0);
		//Con lai
		$('#total-amount-end_cl').val(formatOne(tong_congs));
	}
