...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption caption2">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('loai-phieu-thu');?></div>				
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_c.receipts_type_name"><?=getLanguage('loai-phieu-thu');?></th>
								<th></th>
							</tr>
						</table>
					</div>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="receipts_type_name" id="receipts_type_name" class="searchs form-control " />
								</td>
								</td><td>
								</td><td>
							</tr>
...
<script>
	...
	function save(){
		...
		if(obj.receipts_type_name == ''){
			warning("<?=getLanguage('loai-phieu-thu')?>"); return false;	
		}
		var token = $('#token').val();
		$('.loading').show();
		$.ajax({
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var receipts_type_name = $('.receipts_type_name').eq(e).html().trim();
				 var id = $(this).attr('id');
				 $('#id').val(id);	
				 $('#receipts_type_name').val(receipts_type_name);
			});
		});	
