					...
					<div class="row" style="margin-top:15px;">
						<div class="row">
							<div class="form-group">
								...
								<div class="col-md-5" style="padding-left:0; margin-left:-3px;">
									<input type="text" name="goodsid" id="goodsid" placeholder="" class="search form-control tab-event" />
								</div>
								<div class="col-md-3" style="padding-left:0; margin-left:-3px;">
								...
								<div  style="margin-top:-40px; width:110px; height:90px; border: 1px solid #ddd; margin-bottom:5px;" class="col-md-2" id="viewImg" >
