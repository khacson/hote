	...
	<div class="portlet-title">
		...
		<div class="tools">
			<ul class="button-group pull-right mbottom10">
				...
				<li>
					<a href= "<?=base_url();?>inputreturn.html">
						<button class="button">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-8 ">
									...
									<div class="col-md-6" style="padding:0 !important; ">
										<input checked style="font-size:12px;" type="text" name="price_prepay" id="price_prepay" placeholder="" class="searchs form-control text-right fm-number" value="" readonly />
									</div>
								</div>
							</div>
						</div>
...
<script>
	...
	function setDefault(){
		...
		$('#oderpoid').multipleSelect('setSelects',soid.split(','));
	...
	function actionTemp(){
		...
		$('.quantity').each(function(idx){
			...
			$(this).on('keyup',function(){
				var goodid = $(this).attr('goodid'); 
				var quantitys = parseFloat($(this).val());
	...
	function init(){
		...
		$('#oderpoid').multipleSelect({
			...
			onClick: function(view) {
				...
				window.location = '<?=base_url();?>inputreturn/formEditSO?soid='+soid;
			}
		});
