...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('loai-hinh-so-huu');?></div>	
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_p.ownertype_name"><?=getLanguage('loai-hinh-so-huu')?></th>
								<th id="ord_p.ownertype_name"><?=getLanguage('vi-tri')?></th>
								<th></th>
								<th></th>
							</tr>
						</table>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="ownertype_name" id="ownertype_name" class="searchs form-control" />
								</td>
								<td>
...
<script>
	...
	function searchFunction(){
		$("#ownertype_name,#ordering").keyup(function() {
			searchList();	
		});
	}
	...
	function save(func,id){
		...
		if(obj.ownertype_name == ""){
			warning('<?=getLanguage('loai-hinh-so-huu-khong-duoc-trong');?>'); 
			$("#ownertype_name").focus();
			return false;		
		}
		$('.loading').show();
		$.ajax({
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var ownertype_name = $('.ownertype_name').eq(e).html().trim();
				 var id = $(this).attr('id');
				 $('#id').val(id);	
				 $('#ownertype_name').val(ownertype_name);
			});
		});	
