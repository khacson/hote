...
<div class="portlet box blue">
	...
	<div class="portlet-body">
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
					<label class="control-label col-md-4">Loại khách hàng (<span class="red">*</span>)</label>
					<div class="col-md-8">
...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-bars"><i>Có <span class="viewtotal"></span> <span class='lowercase'>hàng hóa</span></i></i>			
		</div>
		<div class="tools">
			<a href="javascript:;" class="collapse">
			</a>
